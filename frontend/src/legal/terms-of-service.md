...
- **Enterprise editions** are provided to business customers under a separate commercial agreement ("Enterprise Agreement"). Where an Enterprise Agreement conflicts with these Terms, the Enterprise Agreement controls for that customer.

**Any company may use JPilot for its own internal operations.** The Service and Software may **not be resold, sublicensed, rented, or otherwise made available to third parties as a service or product**, whether for a fee or not, except under an Enterprise Agreement that expressly permits it.

**Managed Service Providers (MSPs).** If you use JPilot to deliver services to, or to manage infrastructure on behalf of, third parties (for example, as a managed-services or hosting provider), you must obtain an **Enterprise license per managed server**. The price of such a license is established by Nexxus Tech based on the **scope, functionalities, and time/effort** involved, as set out in the applicable Enterprise Agreement or statement of work.
...
The Free edition is provided at no charge and may have functional or usage limits. Paid and Enterprise plans are billed as described at the time of purchase or in your Enterprise Agreement. Except where required by law or expressly stated, fees are non-refundable. We may change plans, limits, or pricing on reasonable notice; changes do not apply retroactively to a paid term already purchased.
...
The Free edition is provided **without any service-level agreement, uptime guarantee, or support commitment**. We may modify, suspend, limit, or **discontinue the Service or any feature at any time, with or without notice, and without liability to you**. Service-level, support, or availability commitments, if any, apply **only under an Enterprise Agreement**.
...
"NetScaler" and "Citrix" are trademarks of their respective owner (Cloud Software Group). "OpenAI", "Anthropic", "Claude", "Google", "Gemini", "xAI", "Grok", "DeepSeek", "Brave", and other product and company names are trademarks of their respective owners. **Nexxus Tech and JPilot are independent and are not affiliated with, sponsored by, endorsed by, or certified by any of these companies.** All third-party names and marks are used solely for identification and interoperability purposes.
