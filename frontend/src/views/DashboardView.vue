<template>
  <div class="page">
    <PageHeader
      title="Dashboard"
      subtitle="Overview of your NetScaler Copilot platform"
    />

    <div class="welcome-panel mb-5">
      <h2>Welcome to NetScaler Copilot</h2>
      ...
      <div class="col-12 md:col-8">
        <div class="content-panel content-panel-padded quick-panel">
          ...
          <div class="flex flex-wrap gap-3 mt-3">
            <Button label="Open Copilot" icon="pi pi-comments" size="small" @click="router.push('/copilot')" />
