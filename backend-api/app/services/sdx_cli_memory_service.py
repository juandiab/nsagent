"""Load and search NetScaler SDX SVM memory for Copilot RAG."""
...
MEMORY_FILENAME = "netscaler_sdx_cli_memory.md"
MEMORY_VENDOR = "sdx"
...
def _load_memory_markdown() -> str:
    ...
    path = _memory_path()
    if not path.is_file():
        raise FileNotFoundError(f"SDX memory file not found: {path}")
